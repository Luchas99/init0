$(document).ready(function() {
    ...
    toastr.error('You have 4 notifications', 'Welcome to Umega');
    ...
    table.buttons().container()
        .appendTo('#order-table_wrapper .col-sm-6:eq(0)');
    ...
    function addNewEvent() {
        ...
        $("#fullcalendar").fullCalendar('renderEvent', {
            ...
            backgroundColor: $('#inputBackgroundEvent').val(),
            borderColor: '#FFF'
        }, true);
    }
